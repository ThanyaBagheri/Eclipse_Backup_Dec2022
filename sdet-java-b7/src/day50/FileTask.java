...
public class FileTask {
	public static void main(String[] args) {
		...
		System.out.println(sdet.getAbsolutePath());///Users/thanyaratsaengsing/eclipse-workspace/sdet-java-b7/src/day50/sdet
		...
		try {
			File f0 = new File(sdet.getAbsolutePath() + "/pom.xml");
			f0.createNewFile();
