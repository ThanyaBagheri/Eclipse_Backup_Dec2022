...
public class EnumInJava {
	...
	public static void main(String[] args) {
		...
		String country = InputFromUser.getInput("Enter country:");
		
		//                                     "USA"
		Country enumCountry = Country.valueOf(country); 
		System.out.println(enumCountry);
		System.out.println(getFeeByCountry(enumCountry));
